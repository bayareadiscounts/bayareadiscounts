...
- [Education](#education)
- - [Local Colleges & Universities](#local-colleges--universities)
- [Food](#food)
- [Health](#health)
- [Legal](#legal)
...
| Program | Area | Eligibility | Benefit | How to Use It | Timeframe | Link |
|--------|------|-------------|---------|---------------|-----------|------|
| De Anza Roary's Market | De Anza | 🎓 | Free groceries, meat, produce, hot meals (Wednesdays), clothing, plus Crumbl cookies while supplies last | Visit with DASG student card | Academic year | [Roary's Market](https://www.deanza.edu/resources/hub/roarys-market/index.html) |
| SFSU Gator Groceries | SF State | 🎓 | Free groceries serving 700-800 students weekly, no proof of need required | Walk in with student ID | Academic year | [Gator Groceries](https://basicneeds.sfsu.edu) |
| SJSU Spartan Food Pantry | San Jose State | 🎓 | Free groceries (33,000+ visits annually), no appointment or income proof required | Walk in with Tower Card | Academic year | [Spartan Food Pantry](https://www.sjsu.edu/sjsucares) |
| UC Berkeley Food Pantry | UC Berkeley | 🎓 | Free groceries, no questions asked, weekly visits allowed | Visit pantry with student ID | Academic year | [Basic Needs](https://basicneeds.berkeley.edu) |

#### Legal Services

| Program | Area | Eligibility | Benefit | How to Use It | Timeframe | Link |
|--------|------|-------------|---------|---------------|-----------|------|
| De Anza Legal Advice | De Anza | 🎓 | Free 30-minute legal consultations via Zoom for DASG cardholders | Complete online appointment request form | Academic quarters | [Legal Advice](https://www.deanza.edu/collegelife/legaladvice.html) |
| Stanford ASSU Legal Counseling | Stanford | 🎓 | Free legal advice for students, spouses, partners on landlord/tenant, identity theft, contracts, small claims | Schedule appointment | Academic year | [Legal Counseling](https://www.assu.stanford.edu/services/legal-counsel-office) |
| UC Berkeley Student Legal Services | UC Berkeley | 🎓 | Free legal guidance on tenant rights, contracts, consumer matters | Schedule appointment online | Academic year | [SLS](https://sls.berkeley.edu) |

#### Recreation & Fitness

| Program | Area | Eligibility | Benefit | How to Use It | Timeframe | Link |
|--------|------|-------------|---------|---------------|-----------|------|
| De Anza Bike Rentals | De Anza | 🎓 | Free bicycle rentals for students 18+ with DASG ID cards, renewable quarterly | Apply for bike program | Academic quarters | [DASG Bike Program](https://www.deanza.edu/collegelife/dasgbikeprogram.html) |
| SJSU Spartan Rec Center | San Jose State | 🎓 | 128,000 sq ft facility with two 50-meter pools, climbing wall, indoor track included in fees | Access with Tower Card | Academic year | [SRAC](https://www.sjsu.edu/recreation/) |
| UC Berkeley Aquatic Center | UC Berkeley | 🎓 | Free kayak and SUP rentals (up to 2.5 hours) at Berkeley Marina | Reserve online with student ID | Academic year | [Adventures](https://recwell.berkeley.edu/wellness-offerings/adventures/) |

#### Scholarships & Financial Aid

| Program | Area | Eligibility | Benefit | How to Use It | Timeframe | Link |
|--------|------|-------------|---------|---------------|-----------|------|
| CCSF Free City Grant | City College SF | 🎓 | Full tuition waiver for San Francisco residents | Enroll at CCSF and apply | Academic year | [CCSF Free City](https://www.ccsf.edu/free-city) |
| De Anza Promise | De Anza | 🎓 | Two years free tuition and fees | Apply as incoming student | First-time students | [De Anza Promise](https://www.deanza.edu/financialaid/types/) |
| Ohlone Promise Scholarship | Ohlone College | 🎓 🧒 | Full tuition, books, and fees for two years (up to 60 units) for Tri-City area high school seniors maintaining 2.0 GPA | Apply as graduating senior | High school seniors | [Ohlone Promise](https://www.ohlone.edu/foundation/ohlonepromisescholarship) |

#### Transit Benefits

| Program | College/University | Eligibility | Benefit | How to Use It | Timeframe | Link |
|--------|------|-------------|---------|---------------|-----------|------|
